...
**Summary:** Documentation and files about the **Multi-Robot Path Planning** component, as part of the `GUT-AI Initiative <https://github.com/GUT-AI/gut-ai>`_.
...
The purpose of this component is to perform **Multi-Robot Path Planning** (i.e. *visuo-motor* abilities).
